...
Просто добавьте в скрипт сборки модуль pipr.cpp и заголовок pipr.h. Просто будет в случае если вы уже интегрировали в свой проект SDL2 и imgui 
(как пришивать их - в данном руководстве не рассматривается).

Для примера можно посмотреть решение `pipr_demo`.
